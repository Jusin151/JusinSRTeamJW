#include "Button_Episode.h"
#include "GameInstance.h"
#include "CUI_Manager.h"

CButton_Episode::CButton_Episode(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CButton_Base(pGraphic_Device)
{
}

CButton_Episode::CButton_Episode(const CButton_Episode& Prototype)
	: CButton_Base(Prototype),
...
HRESULT CButton_Episode::Initialize_Prototype()
{
...
HRESULT CButton_Episode::Initialize(void* pArg)
{
	if (FAILED(Ready_Components()))
...
void CButton_Episode::Priority_Update(_float fTimeDelta)
{
}

void CButton_Episode::Update(_float fTimeDelta)
{
...
void CButton_Episode::Late_Update(_float fTimeDelta)
{
	if (FAILED(m_pGameInstance->Add_RenderGroup(CRenderer::RG_UI, this)))
		return;
}

HRESULT CButton_Episode::Render()
{
...
HRESULT CButton_Episode::Ready_Components()
{
...
CButton_Episode* CButton_Episode::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CButton_Episode* pInstance = new CButton_Episode(pGraphic_Device);
...
CGameObject* CButton_Episode::Clone(void* pArg)
{
	CButton_Episode* pInstace = new CButton_Episode(*this);
