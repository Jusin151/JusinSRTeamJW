...
class CUI_Episode_Hub final : public CUI_Shop_Base
{
	enum MAP_IMAGE_ENUM
	{
		FIRST_NORMAL_MAP,SECOND_NORMAL_MAP,

		FIRST_BOSS_MAP,SECOND_BOSS_MAP,THIRD_BOSS_MAP
	};
	enum MAP_STATE_ENUM
	{
		...
		SECOND_NORMAP_MAP_GRAY = 2,
		SECOND_NORMAP_MAP_COLOR = 3,
		SECOND_NORMAP_MAP_RED = 4,

		FIRST_BOSS_MAP_GRAY = 5,
		FIRST_BOSS_MAP_COLOR = 6,
		FISRT_BOSS_MAP_RED = 7,

		SECOND_BOSS_MAP_GRAY=8,
		SECOND_BOSS_MAP_COLOR=9,
		SECOND_BOSS_MAP_RED=10,

		THIRD_BOSS_MAP_GRAY=11,
		THIRD_BOSS_MAP_COLOR=12,
		THIRD_BOSS_MAP_RED=13,
	};
