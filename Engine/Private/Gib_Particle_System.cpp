...
HRESULT CGib_Particle_System::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CGib_Particle_System::Initialize(void* pArg)
{
...
void CGib_Particle_System::Reset_Particle(ATTRIBUTE* pAttribute, void* pArg)
{
...
HRESULT CGib_Particle_System::Pre_Render()
{
...
CGib_Particle_System* CGib_Particle_System::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
    CGib_Particle_System* pInstance = new CGib_Particle_System(pGraphic_Device);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX("Failed to Created : CGib_Particle_System");
...
CGib_Particle_System* CGib_Particle_System::Clone(void* pArg)
{
    CGib_Particle_System* pInstance = new CGib_Particle_System(*this);
...
void CGib_Particle_System::Free()
{
    __super::Free();
}
